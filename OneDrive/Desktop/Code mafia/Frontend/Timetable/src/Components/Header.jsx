...
const Header = () => {
  ...
  const [notifications] = useState([
    { id: 1, message: 'New assignment posted for Mathematics', time: '10 mins ago' },
    { id: 2, message: 'Your grade for Science has been updated', time: '1 hour ago' },
    { id: 3, message: 'Exam schedule changed for next week', time: '2 hours ago' },
  ]);
